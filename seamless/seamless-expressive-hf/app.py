...
UPDATED_LANGUAGE_LIST = {
    "English": ["Mandarin Chinese", "French", "German", "Spanish"],
    "Mandarin Chinese": ["English", "French", "German", "Spanish"],
    "French": ["Mandarin Chinese", "English", "German", "Spanish"],
    "German": ["Mandarin Chinese", "English", "French", "Spanish"],
    "Spanish": ["Mandarin Chinese", "English", "French", "German"],
}
